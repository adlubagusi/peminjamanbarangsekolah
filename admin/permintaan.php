                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Permintaan Peminjaman</strong>
                        </div>
                        <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="proses-pinjam.php?mode=tolak&id=<?php echo $id;?>"> 
